...
local updateInterval = 1 -- Run x times per second, up to 30. 1/s works well
...
TeamsManager.config.alertVolume = 1.0 -- Set the volume between 0.0 and 1.0. NOT USED
...
local myCommanderRules = {thresholdHP = {reAlertSec=60, mark="Com In Danger", alertSound="sounds/commands/cmd-selfd.wav", threshMinPerc=.6, priority=0}} -- damaged = {reAlertSec=30} Towards the end of games there's a lot of damage, so I recommend using "thresholdHP" for the few units you care about -- will sound alert when Commander idle/15 secs, (re)damaged once per 30 seconds (unlimited), and when damage causes HP to be under x%
...
local myNukeRules = {stockpile = {mark="Nuke Ready", alertSound="sounds/commands/cmd-selfd.wav"}}
-- More Unit Types:
...
local allyFactoryT2Rules = {finished = {sharedAlerts=true, maxAlerts=1, mark="T2 Ally", alertDelay=30, messageTo="me", messageTxt="T2 Ally"}} -- So you can badger them for a T2 constructor ;)
local allyMexRules = {destroyed = {sharedAlerts=true, mark="Ally Mex Lost", reAlertSec=120}}
local allyEnergyGenT2Rules = {destroyed = {sharedAlerts=true, reAlertSec=60, mark="Ally Fusion Lost"}}
local allyRadarRules = {destroyed = {sharedAlerts=true, mark="Ally Radar Lost"}} -- , alertDelay=30
local allyNukeRules = {stockpile = {sharedAlerts=true, messageTo="me", messageTxt="Ally Nuke Ready"}}
-- Bomber rules are in customGroups section below
...
local enemyFactoryT2Rules = {los = {sharedAlerts=true, maxAlerts=1, mark="T2 Factory"}} -- Hope you're ready.
local enemyAntiNukeRules = {los = {sharedAlerts=true, maxAlerts=1, reAlertSec=1, mark="AntiNuke Spotted", alertSound="sounds/commands/cmd-selfd.wav"}}
local enemyNukeRules = {los = {sharedAlerts=true, maxAlerts=1, reAlertSec=1, mark="Nuke Spotted", alertSound="sounds/commands/cmd-selfd.wav"}}
-- Bomber rules are in customGroups section below
...
local spectatorLRPCRules = {created = {sharedAlerts=true, maxAlerts=5, mark="LRPC Started"}, finished = {sharedAlerts=true, maxAlerts=5, mark="LRPC Finished", alertSound="sounds/commands/cmd-selfd.wav"}}
local spectatorRFLRPCRules = {created = {sharedAlerts=true, maxAlerts=5, mark="RFLRPC Started"}, finished = {sharedAlerts=true, maxAlerts=5, mark="RFLRPC Finished", alertSound="sounds/commands/cmd-selfd.wav"}}
...
local enemyCustomGroups = {
  ["bomberT1"] = {["unitNames"] = {"Stormbringer","Dam Buster","Whirlwind","Harbinger"}, ["eventsRules"] = {["los"] = {sharedAlerts=true, maxAlerts=1, priority=0, mark = "BomberT1"}}},
  ["bomberT2"] = {["unitNames"] = {"Blizzard","Liche","Stiletto","Hailstorm","Phoenix"}, ["eventsRules"] = {["los"] = {sharedAlerts=true, maxAlerts=1, priority=0, mark = "BomberT2"}}},
  ["gunshipT1"] = {["unitNames"] = {"Banshee","Sabre","Cutlass","Mosquito"}, ["eventsRules"] = {["los"] = {sharedAlerts=true, maxAlerts=1, priority=0, mark = "GunshipT1"}}},
  ["gunshipT2"] = {["unitNames"] = {"Hornet","Roughneck","Wasp"}, ["eventsRules"] = {["los"] = {sharedAlerts=true, maxAlerts=1, priority=0, mark = "GunshipT2"}}},
  ["torpPlane"] = {["unitNames"] = {"Puffin","Tsunami","Monsoon","Cormorant","Angler","Aesacus"}, ["eventsRules"] = {["los"] = {sharedAlerts=true, maxAlerts=1, priority=0, mark = "Torpedo Plane"}}},
}
local spectatorCustomGroups = {
  ["bomberT1"] = {["unitNames"] = {"Stormbringer","Dam Buster","Whirlwind","Harbinger"}, ["eventsRules"] = {["finished"] = {sharedAlerts=true, maxAlerts=1, priority=0, mark = "BomberT1"}}},
  ["bomberT2"] = {["unitNames"] = {"Blizzard","Liche","Stiletto","Hailstorm","Phoenix"}, ["eventsRules"] = {["finished"] = {sharedAlerts=true, maxAlerts=1, priority=0, mark = "BomberT2"}}},
  ["gunshipT1"] = {["unitNames"] = {"Banshee","Sabre","Cutlass","Mosquito"}, ["eventsRules"] = {["finished"] = {sharedAlerts=true, maxAlerts=1, priority=0, mark = "GunshipT1"}}},
  ["gunshipT2"] = {["unitNames"] = {"Hornet","Roughneck","Wasp"}, ["eventsRules"] = {["finished"] = {sharedAlerts=true, maxAlerts=1, priority=0, mark = "GunshipT2"}}},
  ["torpPlane"] = {["unitNames"] = {"Puffin","Tsunami","Monsoon","Cormorant","Angler","Aesacus"}, ["eventsRules"] = {["finished"] = {sharedAlerts=true, maxAlerts=1, priority=0, mark = "Torpedo Plane"}}}
}
